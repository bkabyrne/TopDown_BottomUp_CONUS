...
if __name__ == '__main__':
    ...
    Regional_CO2_Budget = pd.concat([Regional_fluxes, Regional_crop_grass_stock, Regional_TopDown_mean, Regional_TopDown_std], axis=1)
    Regional_CO2_Budget.to_csv('../Data_processed/Regional_CO2_Budget.csv', index=False)
